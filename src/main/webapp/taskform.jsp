...
<body id="page-top">
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								<!-- Portfolio Modal - Title-->
								<h2
									class="portfolio-modal-title text-secondary text-uppercase mb-0">Task Dashboard</h2>
								<!-- Icon Divider-->
								<div class="divider-custom">
									<div class="divider-custom-line"></div>
									<div class="divider-custom-icon">
								...
								<!-- Portfolio Modal - Text-->
								<form id="showdet" method="post" action="endTask">
                                    <div class="form-group form-button">
                                        <input type="submit" name="endtask" id="endtask" class="btn btn-primary" value="Get" />
                                    </div>
								</form>
							</div>
						</div>
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								<!-- Portfolio Modal - Title-->
								<h2
									class="portfolio-modal-title text-secondary text-uppercase mb-0">Help</h2>
								<!-- Icon Divider-->
								<div class="divider-custom">
									<div class="divider-custom-line"></div>
									<div class="divider-custom-icon">
								...
								<!-- Portfolio Modal - Image-->
								<img class="img-fluid rounded mb-5"
									src="assets/img/portfolio/helpl.png" alt="..." />
								<!-- Portfolio Modal - Text-->
								<form id="showdet" method="post" action="showdetail">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="showsetails" type="text" name="showdetails" placeholder="Enter Account number" data-sb-validations="required" /> 
                                        <label for="showdetails">Enter Account number</label>
                                        <div class="invalid-feedback" data-sb-feedback="showdetails:required">Account number is required.</div>
                                    </div>
                                    <div class="form-group form-button">
                                        <input type="submit" name="showdetials" id="showdetails" class="btn btn-primary" value="Get" />
                                    </div>
								</form>
	...
	<div class="portfolio-modal modal fade" id="portfolioModal15"
		tabindex="-1" aria-labelledby="portfolioModal15" aria-hidden="true">
		<div class="modal-dialog modal-xl">
			<div class="modal-content">
				<div class="modal-header border-0">
					<button class="btn-close" type="button" data-bs-dismiss="modal"
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								<!-- Portfolio Modal - Title-->
								<h2
									class="portfolio-modal-title text-secondary text-uppercase mb-0">Task Dashboard
									</h2>
								<!-- Icon Divider-->
								<div class="divider-custom">
									<div class="divider-custom-line"></div>
